...
(custom-set-variables
 ...
 '(package-selected-packages
   '(gnu-elpa-keyring-update phps-mode terraform-mode hcl-mode typescript-mode rust-mode go-mode vue-mode markdown-mode rjsx-mode json-mode yaml-mode helm web-mode use-package coffee-mode yaml-mode))
